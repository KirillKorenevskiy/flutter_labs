...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  List<String> mountains = [
    ...
    "lib/images/mountain2.png",
    "lib/images/mountain3.png"
  ];
  List<String> mountains_text = ["Cascade", "Yosemite", "Everest"];
  List<String> mountains_text2 = [
    "Canada, Banff",
    "USA, California",
    "Himalayas"
  ];
            ...
            child: Align(
              ...
              child: TabBar(
                ...
                indicator: CircleTabIndicator(
                    color: const Color(0xFF5d69b3), radius: 4),
                tabs: const [
                  Tab(text: "Places"),
                    ...
                    return InkWell(
                        onTap: () {
                          MyArguments myArguments = MyArguments(
                              mountains[index],
                              "${mountains_text[index]} hhgaesgrtfhnrdse1",
